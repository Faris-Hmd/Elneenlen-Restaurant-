...
<html>
  ...
  <head>
    ...
    <script src="https://kit.fontawesome.com/fbc8edf9b0.js" crossorigin="anonymous"></script>
...
<div class="creatAccount">haven’t account? <span onclick="showForm(1)">Creat now</span></div>
	</form>
